    <?php 
            $bus1=['ekonomi','bisnis','eksekutif'];
            ;?>
<section class="container-fluid px-0">
    <div class="row align-items-center">
        <div class="col-lg-6">
            <div class="text-center d-none d-lg-block"><h1>Bus Puspajaya Indonesia</h1></div>
            <div class="text-center d-none d-lg-block"><h1>Bus Puspajaya Indonesia</h1></div>
            <div class="text-center d-none d-lg-block"><h1>Bus Puspajaya Indonesia</h1></div>
            <div class="text-center d-none d-lg-block"><h1>Bus puspajaya Indonesia</h1></div>
            <div class="text-center d-none d-lg-block"><h1>Bus Pariwisata Indonesia</h1></div>
        </div>
        <div class="col-lg-6 mt-5 mr-5">
            <img class="img-fluid" src="<?= BASEURL; ?>/img/puspajaya.jpg" alt="">
        </div>
        <div class="row align-items-center mt-5">
        <div class="col-lg-6">
            <img class="img-fluid" src="<?= BASEURL; ?>/img/kabin.jpg" alt="">
        </div>
        <div class="col-lg-6">
            <img class="img-fluid" src="<?= BASEURL; ?>/img/bangku.png" alt="">
        </div>
        </div>
        <div class="row align-items-centern m-auto mt-5 mb-5">
